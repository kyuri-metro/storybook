...
const meta = {
  title: 'kyuri-metro/shmetro-line-id-block-2020-type-2-svg-generator',
  tags: ['autodocs'],
  parameters: {
    docs: {
      description: {
        component:
          '调用 npm 包 `@kyuri-metro/shmetro-line-id-block-2020-type-2-svg-generator` 的生成函数，在 Controls 中调整参数后即时预览 SVG。',
      },
    },
  },
  args: defaultShmetroArgs,
  argTypes: lineIdBlockArgTypes,
  render: (args) => renderShmetroLineIdBlock(args, generateLineIdBlock2020Type2Svg, '2020-type-2'),
